...
@NoArgsConstructor
@Getter
public class Student implements StorageValue {
  ...
  public boolean equals(Object o) {
    ...
    if (getHometown() != null ? !getHometown().equals(student.getHometown())
        : student.getHometown() != null) {
      return false;
    }
    return getBirthDate() != null ? getBirthDate().equals(student.getBirthDate())
